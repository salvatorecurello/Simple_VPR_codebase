...
def write_labels_to_image(labels=["text1", "text2"]):
    ...
    #font = ImageFont.truetype("/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf", FONTSIZE) # old
    font = ImageFont.truetype("/content/drive/MyDrive/Project/Simple_VPR_codebase/utils/DejaVuSans.ttf", FONTSIZE)
